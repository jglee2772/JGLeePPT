          ...
          <div className="projects-grid">
            <div className="project-card">
              <div className="project-card-main">
                ...
                <div className="project-images">
                  ...
                  <img src={cinemaImage2} alt="시네마 컷 2" className="project-image" />
                </div>
              ...
              <div className={`project-card-expanded ${showDetails.cinema || showProblemSolving.cinema ? 'open' : ''}`}>
                {showDetails.cinema && (
            ...
            <div className="project-card">
              <div className="project-card-main">
                ...
                <p className="project-period">참여도 : 40%</p>
                ...
                <div className="project-images">
                  ...
                  <img src={insimimg2} alt="면접시뮬사이트 컷 2" className="project-image" />
                </div>
              ...
              <div className={`project-card-expanded ${showDetails.insim || showProblemSolving.insim ? 'open' : ''}`}>
                {showDetails.insim && (
                  <div className="detail-content">
                    <div className="project-tags">
                      <span>HTML/CSS</span>
            ...
            <div className="project-card">
              <div className="project-card-main">
                ...
                <div className="project-images">
                  ...
                  <img src={chatfoodImage2} alt="챗푸드 컷 2" className="project-image" />
                </div>
              ...
              <div className={`project-card-expanded ${showDetails.chatfood || showProblemSolving.chatfood ? 'open' : ''}`}>
            ...
            <div className="project-card">
              <div className="project-card-main">
                ...
                <div className="project-images">
                  ...
                  <img src={mytestwebImage2} alt="마이테스트웹 컷 2" className="project-image" />
                </div>
              ...
              <div className={`project-card-expanded ${showDetails.mytestweb || showProblemSolving.mytestweb ? 'open' : ''}`}>
